...
from ...modules_lora.attention import SpatialTransformerLoRA
from ...modules_lora.diffusionmodules.util import (
    avg_pool_nd,
    checkpoint,
    conv_nd,
    linear,
    ...
    def __init__(
                        ...
                        layers.append(
                            ...
                            if not use_spatial_transformer
                                ...
                                SpatialTransformerLoRA(
                                    ...
                                    use_checkpoint=use_checkpoint,
                                    name = self.name + '_input_blocks_'+str(n)+'_1',
                                )
                            )
                        )
        ...
        self.middle_block = TimestepEmbedSequential(
            ...
            if not use_spatial_transformer
                ...
                SpatialTransformerLoRA(  # always uses a self-attn
                    ch,
                    num_heads,
                    dim_head,
                    ...
                    attn_type=spatial_transformer_attn_type,
                    use_checkpoint=use_checkpoint,
                    name = self.name + '_middle_block_1',
                )
            ),
            checkpoint_wrapper_fn(
                ResBlock(
                        ...
                        layers.append(
                            ...
                            if not use_spatial_transformer
                                ...
                                SpatialTransformerLoRA(
                                    ...
                                    attn_type=spatial_transformer_attn_type,
                                    use_checkpoint=use_checkpoint,
                                    name = self.name + '_output_blocks_'+str(n)+'_1',
                                )
                            )
                        )
